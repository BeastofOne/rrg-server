...
# Download Preview — uses pre-generated bytes from worker state
with chat_tab:
    preview_b64 = st.session_state.worker_state.get("preview_docx")
    preview_name = st.session_state.worker_state.get("preview_filename", "preview.docx")
    if (
        preview_b64
