...
| WiFi | SpectrumSetup-E0 / livelyocean591 |
...
Windmill config:
- `DATABASE_URL` — postgres://postgres:windmill@db/windmill
...
- `FORCE_SSL` — true
- `SECRET_KEY_BASE` — supersecretkeybase1234567890abcdef
...
3. **Default SSH password** — `andrea:password` should be changed
